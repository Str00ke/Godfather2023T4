...
public class RopeControllerSimple : MonoBehaviour 
{
    ...
    public float kRopeNum/* = 0.01f*/;
    public float springFactor/* = 1.0f*/;
    public float damperFactor/* = 0.8f*/;
    ...
    private void UpdateSpring()
    {
        ...
        float ropeForce = ropeMass * gravity;
        ...
        //Is about 146000
        float kRope = ropeForce / kRopeNum;

        //print(ropeMass);

        //Add the value to the spring
        springJoint.spring = kRope * springFactor;
        springJoint.damper = kRope * damperFactor;
